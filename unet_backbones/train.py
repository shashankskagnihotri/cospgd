...
# * Dataset parameters
    parser.add_argument('--dataset', default='cityscapes', type=str, help='dataset to train/eval on like pascalvoc2012 or cityscapes. Dataset PASCAL VOC2012 is currently not supported')
